...
<html>
  ...
  <body>
      <h1>TITRE DE LA MISSION</h1>
    <?php
        $recup_pub = $db->query("SELECT * FROM mission");   
        while( $pub = $recup_pub->fetch()){
    ?>
    <div class = "pro" style="border: 1px solid black; margin-bottom: 10px">
            <h1><?= $pub['nom_mission'];?></h1>
            <br>
            <p><?= $pub['description_mission'];?></p>
            <br>
           <a href = "Modifier.php?id_mission=<?=$pub['id_mission'];?>">
    ...
    ?>
    <a href="ajouter.php">Ajouter une missions</a>
  </body>
</html>